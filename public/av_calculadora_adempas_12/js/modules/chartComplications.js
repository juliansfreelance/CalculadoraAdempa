const chartComplicationsModule = {
   chartComplications: function (veeva) {
      const FORMAT_ENTERO = value => currency(value, { precision: 0, symbol: '', decimal: ',', separator: '.' });

      const ctx = document.getElementById('chartComplications').getContext('2d');
      const names = veeva.calculadora.chartOptions.chartComplications.names;
      const valoresProcedures = veeva.calculadora.chartOptions.chartComplications.valores;
      ...
      const chartComplications = new Chart(ctx, {
         type: veeva.calculadora.chartOptions.chartComplications.type,
         data: {
            labels: names,
            datasets: [{
               label: veeva.calculadora.chartOptions.chartComplications.title,
         ...
         options: {
            ...
            plugins: {
               ...
               title: {
                  display: true,
                  text: veeva.calculadora.chartOptions.chartComplications.title,
...
export default chartComplicationsModule;

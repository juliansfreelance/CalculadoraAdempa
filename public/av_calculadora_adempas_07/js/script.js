...
let slideSiete = {
   ...
   ini: async function () {
      ...
      if (calculadoraData) {
         ...
         } else if (veeva.calculadora.estadificacion.study !== '') {
      ...
      buttonsElement.forEach(button => {
         button.addEventListener('click', slideSiete.handleButtonClick);
      });
   },
   ...
   popUp: function () {
      ...
      veeva.calculadora.referencias.estadificacion.forEach((estadifi, i)  => {
         ...
         <tr>
            ...
            <td>
               <button onclick="slideSiete.selectGrupo('${estadifi.name}')" class="text-green-600 shadow-md rounded-full p-0.5 bg-white ">
   ...
   validarForm() {
      ...
      if (estadificacion.conoceDistribucion) {
         ...
         if (inputsNotEmpty && sumNot100) {
            ...
            slideSiete.estadificacionPacientes();
         }
      } else {
         slideSiete.estadificacionPacientes();
      }
   ...
   estadificacionPacientes: function () {
      ...
      slideSiete.estadificacionCategoria();
   },

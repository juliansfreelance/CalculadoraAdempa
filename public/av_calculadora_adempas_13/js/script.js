...
let slideTrece = {
   ...
   ini: function () {
      ...
      if (calculadoraData) {
         ...
         slideTrece.getTotalCostsByTechnology();
      } else {
   ...
   toggleFolder: function(folderId) {
      ...
      if (folder.classList.contains('open')) {
         ...
         slideTrece.chartTecnology();
         slideTrece.chartProcedures();
         slideTrece.chartPatient();
         slideTrece.chartComplications();
      }
   },
